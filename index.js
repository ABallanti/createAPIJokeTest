...
//1. intro page
app.get('/', (req, res) => {
    res.send("Welcome to my joke page api")
});
...
app.patch("/jokes/:id", (req, res) => {
    ...
    if (searchIndex === -1) {
        ...
        jokes[searchIndex].jokeType = req.body.type || jokes[searchIndex].jokeType;
        jokes[searchIndex].jokeText = req.body.text || jokes[searchIndex].jokeText;
